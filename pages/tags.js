        ...
        <div className="flex flex-col gap-4 pt-10">
          <div className="flex  justify-between gap-4">
            ...
            <div className="flex flex-col gap-6 w-2/5 p-4 border rounded-lg">
              <label className="font-bold">Add New Tag</label>
          ...
          {/* <div className="flex gap-2">
            <div className="flex flex-col border gap-1 rounded-lg p-4 w-full">
              <div className="font-bold ">Tag URL Settings</div>
              <div className="text-sm">
                Choose the url style from below for Tag page
              </div>
            ...
            <div className="flex flex-col border gap-1 rounded-lg p-4 w-full">
              <div className="font-bold ">Tag SEO Settings</div>
              <div className="text-sm">
                Search engine viability of Tags{" "}
              </div>
